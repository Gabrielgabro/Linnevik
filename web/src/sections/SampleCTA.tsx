  ...
  return (
    <section className="py-8 sm:py-12">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-16 items-center bg-[#0B3D2E] dark:bg-[#145C45] rounded-3xl overflow-hidden">
          {/* Content side - Left */}
          <div className="order-2 lg:order-1 px-4 py-4 lg:pl-12">
