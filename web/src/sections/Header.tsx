    ...
    return (
        <>
            <header className="fixed inset-x-0 top-0 z-50 backdrop-blur">
                <nav className="h-20 w-full flex items-center justify-between px-5" aria-label="Global">
                    ...
                    <div className="hidden md:flex items-center gap-6">
                        ...
                        >
                            ...
                            {cartItemCount > 0 && (
                                <span className={`absolute -top-1 -right-1 bg-[#0B3D2E] dark:bg-[#145C45] text-white text-xs font-bold rounded-full min-w-[20px] h-5 px-1.5 flex items-center justify-center shadow-md transition-transform duration-300 ${animateBadge ? 'animate-cart-badge' : ''}`}>
                                    {displayCount}
                                </span>
                            )}
                        </Link>
                ...
                {/* Mobile Menu */}
                <div
                    className={`md:hidden fixed inset-0 top-20 z-40 bg-white dark:bg-gray-900 transition-transform duration-300 ease-in-out ${mobileMenuOpen ? 'translate-x-0' : 'translate-x-full'
                        }`}
                >
                    <div className="flex flex-col p-6 space-y-6">
                        ...
                        >
                            <div className="relative">
                                ...
                                {cartItemCount > 0 && (
                                    <span className={`absolute -top-2 -right-2 bg-[#0B3D2E] dark:bg-[#145C45] text-white text-xs font-bold rounded-full min-w-[20px] h-5 px-1.5 flex items-center justify-center shadow-md transition-transform duration-300 ${animateBadge ? 'animate-cart-badge' : ''}`}>
                                        {displayCount}
                                    </span>
                                )}
                            </div>
